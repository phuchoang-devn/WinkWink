...
import Dropdown from "../main-components/dropdown/Dropdown";
import useUserInfo, { UserInfoChange } from "../../static/js/hooks/useUserInfo";
import { ReactComponent as CloseIcon } from "../../static/image/profile/close-square.svg"
                        ...
                        <div className="my-profile__languages-container">
                            {
                                userInfo.languages?.map(language => (
                                    <div key={language}
                                        className="my-profile__choosen-language-and-delete">
                                        <div className="my-profile__choosen-language">
                                            {language}
                                        </div>
